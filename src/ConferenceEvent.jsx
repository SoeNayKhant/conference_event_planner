                        ...
                        {venueItems[index].name === "Auditorium Hall (Capacity:200)" ?
                          ...
                          (
                            <div className="button_container">
                              ...
                              <button
                                className={venueItems[index].quantity === 10 ? " btn-success btn-disabled" : "btn-success btn-plus"} onClick={() => handleAddToCart(index)}>
                                &#43;
                              </button>
                            </div>
                          )}
              ...
              <div id="meals" className="venue_container container_main">
                ...
                <div className="input-container venue_selection">
                  ...
                  <input type="number" className="input-box5" id="numberOfPeople" value={numberOfPeople}
                    onChange={(e) => setNumberOfPeople(e.target.value)} min="1" />
                </div>
